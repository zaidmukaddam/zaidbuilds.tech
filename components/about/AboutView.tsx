      ...
      <div className={styles.container}>
        <div className={styles.collaboration}>
          ...
          <p className={styles.description}>
            ...
            offer, contact me at <Link href="mailto:hello@zaidbuilds.tech">hello@zaidbuilds.tech</Link>
          </p>
        </div>
        <div className={styles.contact}>
          ...
          <p className={styles.description}>
            ...
            <Link href="mailto:hello@zaidbuilds.tech">email</Link>,{" "}
            <Link href="https://instagram.com/zaidmukaddam">Instagram</Link>,{" "}
            <Link href="https://twitter.com/zaidmukaddam">Twitter</Link> or other social media. I reply to all messages!
